...
from .views import OANDA_Request_View, send_OANDA_request, get_data, get_data_list, api_get_live_data
...
urlpatterns = [
    ...
    path('api-live-data', api_get_live_data, name="api-live-data")
]
