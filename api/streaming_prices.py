    ...
    while True:
        try:
            for rv in api.request(r):
                ...
                prices_json = rec.json()
                #print(prices_json)
                try: 
                    prices_json["bids"][0]["price"]
                    bids_price = prices_json["bids"][0]["price"]
                    print("ITS NOT A HEARTBEAT, HERES THE PRICE:", bids_price)
                except:
                    print("Is it a heartbeat")
                

                #bids_price = prices_json["bids"][0]["price"]
                #asks_price = data["asks"][0]["price"]
...
if __name__ == '__main__':
    ...
    # Define the command-line arguments in a dictionary
    clargs = {
        '--count': '1000',
        '--instrument': 'USD_CAD',
        '--nice': True,
    ...
    # Now, you can call your main function with the parsed arguments
    main(clargs=clargs)